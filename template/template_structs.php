...
?>
		...
		<head>
			...
			<script type="text/javascript" src="../javascript/testres.js"></script>
		</head>
		<body>
<?php
	}
...
?>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="topbar">
					<a href="http://troyprog.dyndns.tv/~testres/testres.php" class="headlink">Exam Reservation System</a>
				</td>
			</tr>
		</table>
<?php
