 ...
 <table width="600" height="550" border="1" align="center" cellpadding="6" cellspacing="0" class="main_box_background">
	...
	<tr>
    	<td valign="top">
            ...
            <tr><td>
            <p class="mainfont">Please select a test that you wish to make a reservation for.</p>
			<form method="post" action="searchsession.php" name="reserve">
				...
				{	
					...
					echo "<option value=\"" . $testname .  "\">".$classname." ".$testname."</option>";
				}
				?>
				</select>
			...
			<form method="post" action="selectclass.php">
			<p class="mainfont" align="center">
