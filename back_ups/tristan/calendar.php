...
<div style="width: 395px; height: 485px; border: 1px solid #000000; background-image: url(scanLinesBg.gif)">
...
<?php		
		...
		echo '<div style="width: 350px; height: 440px; overflow-y: auto; border: 1px solid rgb(0,0,0); background-image: url(scanLinesBg.gif);">';
...
<?php	
	if(isset($_GET['day'])){
		if(mysql_num_rows($result)!=0){
			echo '<td align="center">';
			echo '<input type="image" src="delete.gif"></td>';
		} else{
		}

		echo '</form><td align="center"><a href="../troy/daily_scheduler.php" class="headlink">Add Session</a></td></tr>';
