						...
						<td>
							...
							?>
								<ul class="mainfont">
									...
									<br><br>
									<li><a href="http://troyprog.dyndns.tv/~testres/RosterUpload.php" class="selectlink"> Import a roster </a></li>
									...
									<br><br>
									<li><a href="./troy/edit_course.php" class="selectlink">Edit courses </a></li>
									Use this option to add or delete a course, including adding more sections.
									<br><br>
									<li><a href="./troy/location.php" class="selectlink"> Add a location </a></li>
									Add a new location to allow tests to be taken.
									<br><br>
									<li><a href="./troy/templated_test_scheduler.php" class="selectlink" > Create a new test </a></li>
									...
									<br><br>
									<li><a href="./tristan/calendar.php" class="selectlink"> Edit a test session </a></li>
